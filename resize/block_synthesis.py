...
from .blocklayer import BlockLayerGenerator
...
class BlockSynthesis(SynthesisPass):
    """
    A pass implementing block synthesis algorithm for circuit resizing.
    ...
    def __init__(
            ...
            layer_generator: LayerGenerator = BlockLayerGenerator(),
        ...
        self.q_block1 = q_block1
        self.q_block2 = q_block2
    ...
    async def synthesize(
        ...
        while not frontier.empty():
            ...
            # Generate successors
            successors = self.layer_gen.gen_successors(top_circuit, self.q_block1, self.q_block2, data)
            ...
            # Evaluate successors
            for circuit in instantiated_circuits:
